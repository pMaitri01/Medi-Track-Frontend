...
const Navbar = () => {
  ...
  return (
    <nav className="pl-nav">
        ...
        <div className="pl-nav-actions">
          ...
          <button
            ...
            onClick={() => {
              ...
              if (menu) menu.classList.toggle("pl-mobile-menu--open");
            }}
          >
            <span /><span /><span />
          </button>
      ...
      <div className="pl-mobile-menu" id="pl-mobile-menu">
        <a href="#features" className="pl-mobile-link" onClick={() => document.getElementById("pl-mobile-menu").classList.remove("pl-mobile-menu--open")}>Features</a>
        <a href="#how-it-works" className="pl-mobile-link" onClick={() => document.getElementById("pl-mobile-menu").classList.remove("pl-mobile-menu--open")}>How It Works</a>
        <a href="#contact" className="pl-mobile-link" onClick={() => document.getElementById("pl-mobile-menu").classList.remove("pl-mobile-menu--open")}>Contact</a>
        <div className="pl-mobile-divider" />
        <button className="pl-btn-outline pl-mobile-btn" onClick={() => navigate("/patient/login")}>Patient Login</button>
        <button className="pl-btn-primary pl-mobile-btn" onClick={() => navigate("/patient/register")}>Patient Sign Up</button>
        {/* <button className="pl-btn-doctor-outline pl-mobile-btn" onClick={() => navigate("/DoctorLogin")}>Doctor Login</button>
        <button className="pl-btn-doctor-ghost pl-mobile-btn" onClick={() => navigate("/DoctorRegister")}>Join as Doctor →</button> */}
      </div>
    </nav>
  );
};
