...
// import DoctorNavbar from "../components/DoctorNavbar"; // Adjust paths if your folders are different
// import DoctorHeader from "../components/DoctorHeader";
// import DoctorFooter from "../components/DoctorFooter";

// export default function DoctorDashboard() {
//   // 1. Define the state here. This is the "source of truth".
//   const [open, setOpen] = useState(true);

//   return (
//     <div style={{ minHeight: "100vh", background: "#f8fafc" }}>
      
//       {/* 2. Pass open and setOpen to the Navbar so the button works */}
//       <DoctorNavbar open={open} setOpen={setOpen} />

//       {/* 3. Wrap everything else in a container that moves with the sidebar */}
//       <div style={{ 
//         display: "flex", 
...
//           paddingBottom: "100px" // Extra space so content isn't hidden by fixed footer
//         }}>
//           <h2 style={{ color: "#1e293b" }}>Welcome to Medi-Track</h2>
//           <p style={{ color: "#64748b" }}>This is your dashboard overview.</p>
          
//           {/* Your Dashboard Cards/Tables go here */}
//           <div >
//             Dashboard Content Area
//           </div>
//         </main>

//         {/* 6. Pass open to the Footer */}
