...
const DoctorRegister = () => {
  ...
  const handleBlur = (e) => {
    ...
    if (name === "experience") {
      if (!t) msg = "Experience is required.";
        ...
        msg = "Experience must be greater than 0.";
    }
  ...
  const validate = () => {
    ...
    if (!t("email")) e.email = "Email is required.";
    ...
    if (!t("qualification")) e.qualification = "Qualification is required.";

    if (!t("experience")) e.experience = "Experience is required.";
        ...
        <div className="dreg-header">
          <div className="dreg-header-top">
            ...
            <div>
              ...
              <p>
                Submit your details. Your account will be reviewed by admin
                before login.
              </p>
            </div>
          </div>
              ...
              <div className="dreg-grid-2">
                <div className="dreg-field">
                  <label className="dreg-label">
                    Full Name <span className="dreg-req">*</span>
                  </label>
                  <input {...inp("fullName", "text", "Dr. Full Name")} />
                  {errors.fullName && (
                    <span className="dreg-error">{errors.fullName}</span>
                  )}
                </div>

                <div className="dreg-field">
                  <label className="dreg-label">
                    Email ID <span className="dreg-req">*</span>
                  </label>
                  <input {...inp("email", "email", "doctor@email.com")} />
                  {errors.email && (
                    <span className="dreg-error">{errors.email}</span>
                  )}
                </div>

                <div className="dreg-field">
                  <label className="dreg-label">
                    Mobile Number <span className="dreg-req">*</span>
                  </label>
                  <input
                  ...
                  />
                  {errors.mobile && (
                    <span className="dreg-error">{errors.mobile}</span>
                  )}
                </div>

                <div className="dreg-field">
                  <label className="dreg-label">
                    Gender <span className="dreg-req">*</span>
                  </label>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    onBlur={handleBlur}
                    className={"dreg-select" + (errors.gender ? " err" : "")}
                  >
                  ...
                  {errors.gender && (
                    <span className="dreg-error">{errors.gender}</span>
                  )}
                </div>

                <div className="dreg-field">
                  <label className="dreg-label">
                    Date of Birth <span className="dreg-req">*</span>
                  </label>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    onBlur={handleBlur}
                    className={"dreg-input" + (errors.dob ? " err" : "")}
                  />

                  {errors.dob && (
                    <span className="dreg-error">{errors.dob}</span>
                  )}
                </div>

                <div className="dreg-field">
                  <label className="dreg-label">
                    Password <span className="dreg-req">*</span>
                  </label>
                  <div className="dreg-pwd-wrap">
                    <input
                      {...inp(
                        "password",
                        show.pwd ? "text" : "password",
                        "Min 6 characters",
                      )}
                    />
                    <button
                  ...
                  {errors.password && (
                    <span className="dreg-error">{errors.password}</span>
                  )}
                </div>

                <div className="dreg-field">
                  <label className="dreg-label">
                    Confirm Password <span className="dreg-req">*</span>
                  </label>
                  <div className="dreg-pwd-wrap">
                    <input
                      {...inp(
                        "confirmPassword",
                        show.cpwd ? "text" : "password",
                        "Re-enter password",
                      )}
                    />
                    <button
                  ...
                  {errors.confirmPassword && (
                    <span className="dreg-error">{errors.confirmPassword}</span>
                  )}
                </div>
              </div>
            </div>
...
/>
                ...
                <div className="dreg-field">
                  <label className="dreg-label">
                    Qualification <span className="dreg-req">*</span>
                  </label>
                  <input {...inp("qualification", "text", "e.g. MBBS, MD")} />
                  {errors.qualification && (
                    <span className="dreg-error">{errors.qualification}</span>
                  )}
                </div>

                <div className="dreg-field">
                  <label className="dreg-label">
                    Experience (years) <span className="dreg-req">*</span>
                  </label>
                  <input {...inp("experience", "number", "e.g. 5")} min="1" />
                  {errors.experience && (
                    <span className="dreg-error">{errors.experience}</span>
                  )}
                </div>

                <div className="dreg-field">
                  <label className="dreg-label">
                    License Registration No. <span className="dreg-req">*</span>
                  </label>
                  <input {...inp("licenseNumber", "text", "e.g. MCI-12345")} />
                  {errors.licenseNumber && (
                    <span className="dreg-error">{errors.licenseNumber}</span>
                  )}
                </div>
              </div>
            </div>
